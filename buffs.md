...
- **Overcrit** (`overcrit`) - Allows critical hits on perfection and completion to chain up to 9 additional times. Each extra crit rolls against `floor(currentCritChance * overcrit / 100)` and adds linearly to the multiplier. Capped at 90%.
